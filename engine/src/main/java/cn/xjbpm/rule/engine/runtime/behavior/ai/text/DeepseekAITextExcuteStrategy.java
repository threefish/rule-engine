...
public class DeepseekAITextExcuteStrategy implements AIExcuteStrategy<AITextNode> {
    ...
    public Map<String, Object> getRequestBody(AITextNode node, FlowContext context) {
        ...
        Map<String, Object> extra_body = new HashMap<>();
        AITextNode.Thinking thinking = node.getThinking();
        if (thinking != AITextNode.Thinking.auto) {
            extra_body.put("thinking", Collections.singletonMap("type", thinking));
        }
